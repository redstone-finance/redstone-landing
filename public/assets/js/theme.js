  ...
  if (element.childNodes.length === 0) {
    angels.forEach(function (angel) {
      ...
      angelItem.innerHTML += '\n        <a\n          href="'
        ...
        .concat(
          angel.name,
          '</p>\n          <p class="mb-0 mt-0" style="height: 75px;">'
        )
        .concat(angel.title, "</p>\n        </a>\n      ");
  ...
  function animateValue(htmlElement, startPoint, interval, pointsPerInterval) {
    ...
    var _step = function step(timestamp) {
      ...
      if (timestamp - previousTimestamp > interval) {
        var progress =
          ((timestamp - previousTimestamp) / interval) * pointsPerInterval;
...
var auditorsPartners = [
  {
    name: "Halborn",
    image: "assets/img/auditors-partners/halborn.png",
  },
  {
    name: "ABDK",
...
var auditorsPartnersChainsCrossChainSection =
  ...
  if (_element.childNodes.length === 0) {
    auditorsPartners.forEach(function (auditorsPartnersElement) {
      ...
      auditorsPartnersItem.innerHTML +=
        '\n        <img\n          loading="lazy"\n          src="'
          .concat(auditorsPartnersElement.image, '"\n          alt="')
          .concat(
            auditorsPartnersElement.name,
            ' Logo"\n          height="60"\n        />\n        <p class="mb-0 mt-2">'
          )
          .concat(
            auditorsPartnersElement.name,
          ...
          .concat(
            (_auditorsPartnersElem =
              auditorsPartnersElement === null ||
              auditorsPartnersElement === void 0
                ? void 0
                : auditorsPartnersElement.title) !== null &&
              _auditorsPartnersElem !== void 0
              ? _auditorsPartnersElem
              : "",
            "</p>\n      "
          );
...
var clientsServicesPageSection = document.getElementById(
...
if (clientsServicesPageSection) {
  ...
  clientsServicesPage.forEach(function (client, index) {
    ...
    fetch(client.tvlUrl).then(function (response) {
      response.json().then(function (tvl) {
        var clientCard = document.getElementById(
...
function generateClientCard(name, logo, url, announcement, tvl) {
  ...
  return '\n    <a\n      href="'
    ...
    .concat(name, "</p>\n        ")
    .concat(
      tvl ? '<p class="mb-0 fs-0">TVL: $'.concat(formattedTvl, "</p>") : "",
      "\n        "
    )
    .concat(
      announcement
        ...
        : "".concat(emptyAnnouncementLink(name)),
      "\n      </div>\n    </a>"
    );
}
function sortFn(a, b) {
  ...
  allClients.sort(sortFn).forEach(function (client, index) {
    ...
    if (client.tvlUrl) {
      fetch(client.tvlUrl).then(function (response) {
        response.json().then(function (tvl) {
          var clientCard = document.getElementById(
            "".concat(allClients[index].name, "_all_clients")
          );
          clientCard.innerHTML = generateClientCard(
            client.name,
            client.logo,
...
function generateTvsElement(tvs) {
  ...
  return '\n    <div class="tvs-link mt-3 mt-md-5">\n      <a\n        href="'
    ...
    .concat(
      tvs
        ? '<h3 class="mb-0"><b>'.concat(tvs, " billion</b></h3>")
